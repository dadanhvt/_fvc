(function () {
    ...
    angular
        .module('app.main.ads')
        .controller('GoogleRunAdsController', GoogleRunAdsController);

    /* @ngInject */
    function GoogleRunAdsController($rootScope, apiService, $mdDialog, $filter, $mdToast) {
        var vm = this;
        ...
        function getCampaigns() {
            apiService.getAPI(SERVER_GETCAMPAIGNS + '?status=' + vm.query.status + '&ads=GG', true, function (e) {
        ...
        function runAds(data, accept) {
            if (data && accept == true) {
                ...
                $mdDialog.show({
                    ...
                    templateUrl: 'app/main/ads/google/add-ads-dialog.tmpl.html',
                    preserveScope: true,
                    autoWrap: true,
                    skipHide: true,
                    controller: 'AddGoogleAdsController',
                    controllerAs: 'vm',
                    locals: {
                        addAds: vm.runAds,
                        data: data
